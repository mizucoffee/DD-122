    ...
    public void onBindViewHolder(final ViewHolder vh, int position) {
        ...
        switch (mListType){
            ...
            case CARD_COLUMN2:
                ...
                vh.detailBtn.setOnClickListener((v) -> mContext.startActivity(new Intent().setClass(mContext, DetailActivity.class).putExtra("program",new Gson().toJson(program))));
                break;
            case LIST:
                vh.linearLayout.setOnClickListener((v) -> mContext.startActivity(new Intent().setClass(mContext, DetailActivity.class).putExtra("program", new Gson().toJson(program))));
                vh.desTv.setText(program.getDetail());
                break;
        }
    }
